...
1. Exported Gerbers and drill files from KiCad
2. Uploaded to the PCBWay portal — DFM check passed first try
3. Picked my specs (2-layer, 1.6mm FR4, HASL, green soldermask)
